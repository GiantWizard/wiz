...
func runAndLogMegaLs() {
	log.Println("[ACTION] Executing 'mega-ls -l' to list files in /remote_metrics...")

	cmd := exec.Command("mega-ls", "-l", "/remote_metrics")
	...
	// Trim whitespace to avoid extra newlines from the command output
