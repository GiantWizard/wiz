...
<script>
    ...
    function handleHashChange() {
      ...
      if (hash === '#/optimize') {
        ...
        // Default to dual expansion if hash is empty or unrecognized
        // And navigate to that default hash so the URL reflects the state
        console.log("Defaulting or unrecognized hash, navigating to #/expand");
        window.location.hash = '#/expand'; // This will trigger another hashchange
      }
    }
